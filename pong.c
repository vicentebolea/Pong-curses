...
main() {
	...
	mvprintw(14,5,"\t\t\tPlayer 1 your controls are 'a' and 'q'");
	mvprintw(15,5,"\t\t\tPlayer 2 your controls are the arrows of the keyboard");
	mvprintw(17,5,"\t\t\tPush ANY key to start, 'p' for pause and ESC to quit");
	getch();
